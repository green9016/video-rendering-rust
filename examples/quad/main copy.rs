...
use hal::{
    ...
    command,
    format as f,
    format::{AsFormat, ChannelType, R8Uint as ColorFormat, Swizzle},
    image as i,
    memory as m,
    pass,
    pass::Subpass,
    ...
    B: hal::Backend,
{
    fn new(
        ...
        let y_height = height * 3 / 2;

        let kind = i::Kind::D2(width as i::Size, y_height as i::Size, 1, 1);
        let row_alignment_mask = limits.optimal_buffer_copy_pitch_alignment as u32 - 1;
        let row_pitch = (width as u32 + row_alignment_mask) & !row_alignment_mask;
        let upload_size = (y_height * row_pitch) as u64;
        ...
        let image_upload_memory = unsafe {
            ...
            device
                ...
                .unwrap();
            let mapping = device.map_memory(&memory, m::Segment::ALL).unwrap();
            for y in 0 .. y_height as usize {
                let row = &(*yuv_data)[y * (width as usize)
                    .. (y + 1) * (width as usize)];
