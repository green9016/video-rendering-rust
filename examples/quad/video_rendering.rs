...
pub struct Renderer<B: hal::Backend> {
    ...
    pub image_upload_buffer: ManuallyDrop<B::Buffer>,
    pub image_logo: ManuallyDrop<B::Image>,
    pub image_srv: ManuallyDrop<B::ImageView>,
    pub buffer_memory: ManuallyDrop<B::Memory>,
    pub image_memory: ManuallyDrop<B::Memory>,
    pub image_upload_memory: ManuallyDrop<B::Memory>,
    ...
    B: hal::Backend,
{
    pub fn new(
        ...
        let yuv_data = frame_generator::generate_frame(width, height, 10);
